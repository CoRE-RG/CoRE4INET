...
/**
 * @brief Class for manipulation of network traffic at IEEE 802.1Qbv queueing level
 *
 * @author Philipp Meyer
 */
class CorruptIEEE8021QbvQueueingManipulation : public virtual CorruptIEEE8021QbvQueueingBase
{
  private:
