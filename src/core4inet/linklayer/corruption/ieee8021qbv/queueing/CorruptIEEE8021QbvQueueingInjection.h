...
/**
 * @brief Class for injection of network traffic at IEEE 802.1Qbv queueing level
 *
 * @author Philipp Meyer
 */
class CorruptIEEE8021QbvQueueingInjection : public virtual CorruptIEEE8021QbvQueueingBase
{
  private:
