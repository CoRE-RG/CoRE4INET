...
/*
 * Device_Specification/IncomingBagAccountImpl.cpp
...
#include "IncomingBagAccount.hpp"
...
/*PROTECTED REGION ID(IncomingBagAccountImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void IncomingBagAccount::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(IncomingBagAccountImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject IncomingBagAccount::eGet(::ecore::EInt _featureID,
...
void IncomingBagAccount::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean IncomingBagAccount::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::Device_Specification::Device_SpecificationPackage::BAGACCOUNT__CONSTRAINTYPE:
        /*PROTECTED REGION ID(IncomingBagAccounteIsSet__IncomingBagAccountm_constrainType) ENABLED START*/
...
void IncomingBagAccount::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr IncomingBagAccount::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Specification::Device_SpecificationPackage_ptr > (::Device_Specification::Device_SpecificationPackage::_instance())->getIncomingBagAccount();
    return _eclass;
}
