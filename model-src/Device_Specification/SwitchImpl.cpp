...
/*
 * Device_Specification/SwitchImpl.cpp
...
/*PROTECTED REGION ID(SwitchImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void Switch::_initialize()
{
    // Supertypes
    ...
    if (m_config)
    {
        ...
        m_config->_setEContainer(
                this,
                ::Device_Specification::Device_SpecificationPackage::_instance()->getSwitch__config());
    }

    /*PROTECTED REGION ID(SwitchImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject Switch::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::Device_Specification::Device_SpecificationPackage::DEVICESPECIFICATION__REFDEVICEMAPPING:
    {
        ...
        return _any;
    case ::Device_Specification::Device_SpecificationPackage::SWITCH__CONFIG:
    {
...
void Switch::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::Device_Specification::Device_SpecificationPackage::SWITCH__CONFIG:
    {
        ::ecore::EObject_ptr _t0 = ::ecorecpp::mapping::any::any_cast<
                ::ecore::EObject_ptr >(_newValue);
        ::Device_Specification::SwitchConfig_ptr _t1 =
                dynamic_cast< ::Device_Specification::SwitchConfig_ptr > (_t0);
        ::Device_Specification::Switch::setConfig(_t1);
    }
        return;
...
::ecore::EBoolean Switch::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
...
void Switch::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr Switch::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Specification::Device_SpecificationPackage_ptr > (::Device_Specification::Device_SpecificationPackage::_instance())->getSwitch();
    return _eclass;
}
