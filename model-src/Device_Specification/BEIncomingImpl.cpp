...
/*
 * Device_Specification/BEIncomingImpl.cpp
...
/*PROTECTED REGION ID(BEIncomingImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void BEIncoming::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(BEIncomingImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject BEIncoming::eGet(::ecore::EInt _featureID,
...
void BEIncoming::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean BEIncoming::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__SIGNATURE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_signature);
    case ::Device_Specification::Device_SpecificationPackage::FRAMERELAYDESCRIPTOR__BUFFERDEPTH:
        /*PROTECTED REGION ID(BEIncomingeIsSet__BEIncomingm_bufferDepth) START*/
    ...
    case ::Device_Specification::Device_SpecificationPackage::CTINCOMING__REMOVESEQUENCENUMBER:
        /*PROTECTED REGION ID(BEIncomingeIsSet__BEIncomingm_removeSequenceNumber) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void BEIncoming::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr BEIncoming::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Specification::Device_SpecificationPackage_ptr > (::Device_Specification::Device_SpecificationPackage::_instance())->getBEIncoming();
    return _eclass;
}
