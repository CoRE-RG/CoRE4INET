...
/*
 * Device_Specification/BagAccountImpl.cpp
...
/*PROTECTED REGION ID(BagAccountImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void BagAccount::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(BagAccountImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject BagAccount::eGet(::ecore::EInt _featureID,
...
void BagAccount::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean BagAccount::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::Device_Specification::Device_SpecificationPackage::BAGACCOUNT__CONSTRAINTYPE:
        /*PROTECTED REGION ID(BagAccounteIsSet__BagAccountm_constrainType) ENABLED START*/
...
void BagAccount::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr BagAccount::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Specification::Device_SpecificationPackage_ptr > (::Device_Specification::Device_SpecificationPackage::_instance())->getBagAccount();
    return _eclass;
}
