...
/*
 * Device_Specification/CTIncomingImpl.cpp
...
/*PROTECTED REGION ID(CTIncomingImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void CTIncoming::_initialize()
{
    // Supertypes
    ...
    {
        m_redundancyFunction->_initialize();
        m_redundancyFunction->_setEContainer(
                this,
                ::Device_Specification::Device_SpecificationPackage::_instance()->getCTIncoming__redundancyFunction());
    }

    /*PROTECTED REGION ID(CTIncomingImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject CTIncoming::eGet(::ecore::EInt _featureID,
...
void CTIncoming::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean CTIncoming::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__SIGNATURE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_signature);
    case ::Device_Specification::Device_SpecificationPackage::FRAMERELAYDESCRIPTOR__BUFFERDEPTH:
        /*PROTECTED REGION ID(CTIncomingeIsSet__CTIncomingm_bufferDepth) START*/
    ...
    case ::Device_Specification::Device_SpecificationPackage::CTINCOMING__REMOVESEQUENCENUMBER:
        /*PROTECTED REGION ID(CTIncomingeIsSet__CTIncomingm_removeSequenceNumber) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void CTIncoming::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr CTIncoming::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Specification::Device_SpecificationPackage_ptr > (::Device_Specification::Device_SpecificationPackage::_instance())->getCTIncoming();
    return _eclass;
}
