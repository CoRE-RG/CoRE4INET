...
/*
 * IP_Configuration/TTTechSwIpImpl.cpp
...
/*PROTECTED REGION ID(TTTechSwIpImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void TTTechSwIp::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(TTTechSwIpImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject TTTechSwIp::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__SYNCHRONIZATIONDELAYTICKS:
    {
        ...
        return _any;
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMBAGENTRIES:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EInt >::toAny(_any,
                m_numBagEntries);
    }
        return _any;
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMDYNAMICCOTSROUTES:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EInt >::toAny(_any,
                m_numDynamicCotsRoutes);
    }
        return _any;
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMANTIMASQUERADINGENTRIES:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EInt >::toAny(_any,
                m_numAntiMasqueradingEntries);
    }
        return _any;
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMSTATICCOTSROUTES:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EInt >::toAny(_any,
                m_numStaticCotsRoutes);
    }
        return _any;
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__SYNCHRONIZATIONDELAYTICKSCM:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EInt >::toAny(_any,
...
void TTTechSwIp::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean TTTechSwIp::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__NUMDIAGNOSISSCHEDULEENTRIES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numDiagnosisScheduleEntries) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_numDiagnosisScheduleEntries != 256;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__VLIDBITS:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_vlIdBits) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_vlIdBits != 12;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__NUMSCHEDULEENTRIES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numScheduleEntries) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__NUMPHYSICALPORTS:
        return ::ecorecpp::mapping::set_traits< ::ecore::EInt >::is_set(
                m_numPhysicalPorts);
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__MAXINTEGRATIONCYCLES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_maxIntegrationCycles) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_maxIntegrationCycles != 256;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__NUMMACACCEPTANCEENTRIES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numMacAcceptanceEntries) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHIP__SYNCHRONIZATIONDELAYTICKS:
        return ::ecorecpp::mapping::set_traits< ::ecore::EInt >::is_set(
                m_synchronizationDelayTicks);
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMBAGENTRIES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numBagEntries) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_numBagEntries != 256;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMDYNAMICCOTSROUTES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numDynamicCotsRoutes) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_numDynamicCotsRoutes != 128;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMANTIMASQUERADINGENTRIES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numAntiMasqueradingEntries) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_numAntiMasqueradingEntries != 32;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__NUMSTATICCOTSROUTES:
        /*PROTECTED REGION ID(TTTechSwIpeIsSet__TTTechSwIpm_numStaticCotsRoutes) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_numStaticCotsRoutes != 128;
        /*PROTECTED REGION END*/
    case ::IP_Configuration::IP_ConfigurationPackage::TTTECHSWIP__SYNCHRONIZATIONDELAYTICKSCM:
        return ::ecorecpp::mapping::set_traits< ::ecore::EInt >::is_set(
                m_synchronizationDelayTicksCM);
...
void TTTechSwIp::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr TTTechSwIp::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::IP_Configuration::IP_ConfigurationPackage_ptr > (::IP_Configuration::IP_ConfigurationPackage::_instance())->getTTTechSwIp();
    return _eclass;
}
