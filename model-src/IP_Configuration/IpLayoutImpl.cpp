...
/*
 * IP_Configuration/IpLayoutImpl.cpp
...
/*PROTECTED REGION ID(IpLayoutImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void IpLayout::_initialize()
{
    // Supertypes
    ...
    if (m_metaInformation)
    {
        ...
        m_metaInformation->_setEContainer(
                this,
                ::IP_Configuration::IP_ConfigurationPackage::_instance()->getIpLayout__metaInformation());
    }

    /*PROTECTED REGION ID(IpLayoutImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject IpLayout::eGet(::ecore::EInt _featureID,
...
void IpLayout::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean IpLayout::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
...
void IpLayout::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr IpLayout::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::IP_Configuration::IP_ConfigurationPackage_ptr > (::IP_Configuration::IP_ConfigurationPackage::_instance())->getIpLayout();
    return _eclass;
}
