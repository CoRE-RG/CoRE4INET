...
/*
 * System_Specification/VirtualLinkImpl.cpp
...
/*PROTECTED REGION ID(VirtualLinkImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void VirtualLink::_initialize()
{
    // Supertypes
    ::System_Specification::ModelElement::_initialize();

    // Rerefences
    for (size_t i = 0; i < m_frameRoute->size(); i++)
    {
        (*m_frameRoute)[i]->_initialize();
        (*m_frameRoute)[i]->_setEContainer(
                this,
                ::System_Specification::System_SpecificationPackage::_instance()->getVirtualLink__frameRoute());
    }
    for (size_t i = 0; i < m_alias->size(); i++)
    {
        (*m_alias)[i]->_initialize();
        (*m_alias)[i]->_setEContainer(
                this,
                ::System_Specification::System_SpecificationPackage::_instance()->getVirtualLink__alias());
    }

    /*PROTECTED REGION ID(VirtualLinkImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject VirtualLink::eGet(::ecore::EInt _featureID,
...
void VirtualLink::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean VirtualLink::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__SIGNATURE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_signature);
    case ::System_Specification::System_SpecificationPackage::VIRTUALLINK__DESTMACADDRESSCF:
        /*PROTECTED REGION ID(VirtualLinkeIsSet__VirtualLinkm_destMacAddressCF) ENABLED START*/
...
void VirtualLink::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr VirtualLink::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getVirtualLink();
    return _eclass;
}
