...
/*
 * System_Specification/AliasImpl.cpp
        ...
        ::ecore::EBoolean _resolve)
{
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
    {
        ...
        return _any;
    case ::System_Specification::System_SpecificationPackage::ALIAS__DOMAIN:
    {
        ::ecorecpp::mapping::any_traits< ::ecore::EString >::toAny(_any,
                m_domain);
    }
...
::ecore::EClass_ptr Alias::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getAlias();
    return _eclass;
}
