...
/*
 * System_Specification/RCVirtualLink.cpp
...
// Default constructor
RCVirtualLink::RCVirtualLink()
{

    /*PROTECTED REGION ID(RCVirtualLinkImpl__RCVirtualLinkImpl) START*/
...
/*PROTECTED REGION ID(RCVirtualLink.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
