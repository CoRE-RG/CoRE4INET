...
/*
 * System_Specification/TimeImpl.cpp
...
::ecore::EClass_ptr Time::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getTime();
    return _eclass;
}
