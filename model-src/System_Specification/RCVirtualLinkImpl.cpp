...
/*
 * System_Specification/RCVirtualLinkImpl.cpp
...
/*PROTECTED REGION ID(RCVirtualLinkImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void RCVirtualLink::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(RCVirtualLinkImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject RCVirtualLink::eGet(::ecore::EInt _featureID,
...
void RCVirtualLink::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean RCVirtualLink::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__SIGNATURE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_signature);
    case ::System_Specification::System_SpecificationPackage::VIRTUALLINK__DESTMACADDRESSCF:
        /*PROTECTED REGION ID(RCVirtualLinkeIsSet__RCVirtualLinkm_destMacAddressCF) ENABLED START*/
    ...
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__SEMANTIC:
        /*PROTECTED REGION ID(RCVirtualLinkeIsSet__RCVirtualLinkm_semantic) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__MAXLENGTH:
        /*PROTECTED REGION ID(RCVirtualLinkeIsSet__RCVirtualLinkm_maxLength) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__REFPERIOD:
        return m_refPeriod;
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__TRANSPARENTCLOCKENABLE:
        /*PROTECTED REGION ID(RCVirtualLinkeIsSet__RCVirtualLinkm_transparentClockEnable) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void RCVirtualLink::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr RCVirtualLink::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getRCVirtualLink();
    return _eclass;
}
