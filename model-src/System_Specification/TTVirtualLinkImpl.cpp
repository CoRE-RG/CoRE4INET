...
/*
 * System_Specification/TTVirtualLinkImpl.cpp
...
/*PROTECTED REGION ID(TTVirtualLinkImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void TTVirtualLink::_initialize()
{
    // Supertypes
    ::System_Specification::DataVirtualLink::_initialize();

    // Rerefences

    /*PROTECTED REGION ID(TTVirtualLinkImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject TTVirtualLink::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__TRANSPARENTCLOCKENABLE:
    {
        ...
        return _any;
    case ::System_Specification::System_SpecificationPackage::TTVIRTUALLINK__RELEASE:
    {
        ::ecorecpp::mapping::any_traits< ::System_Specification::TimeType >::toAny(
                _any, m_release);
    }
        return _any;
    case ::System_Specification::System_SpecificationPackage::TTVIRTUALLINK__DEADLINE:
    {
        ::ecorecpp::mapping::any_traits< ::System_Specification::TimeType >::toAny(
                _any, m_deadline);
    }
...
void TTVirtualLink::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean TTVirtualLink::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__SIGNATURE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_signature);
    case ::System_Specification::System_SpecificationPackage::VIRTUALLINK__DESTMACADDRESSCF:
        /*PROTECTED REGION ID(TTVirtualLinkeIsSet__TTVirtualLinkm_destMacAddressCF) ENABLED START*/
    ...
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__SEMANTIC:
        /*PROTECTED REGION ID(TTVirtualLinkeIsSet__TTVirtualLinkm_semantic) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__MAXLENGTH:
        /*PROTECTED REGION ID(TTVirtualLinkeIsSet__TTVirtualLinkm_maxLength) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__REFPERIOD:
        return m_refPeriod;
    case ::System_Specification::System_SpecificationPackage::DATAVIRTUALLINK__TRANSPARENTCLOCKENABLE:
        /*PROTECTED REGION ID(TTVirtualLinkeIsSet__TTVirtualLinkm_transparentClockEnable) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::System_Specification::System_SpecificationPackage::TTVIRTUALLINK__RELEASE:
        return ::ecorecpp::mapping::set_traits<
                ::System_Specification::TimeType >::is_set(m_release);
    case ::System_Specification::System_SpecificationPackage::TTVIRTUALLINK__DEADLINE:
        return ::ecorecpp::mapping::set_traits<
                ::System_Specification::TimeType >::is_set(m_deadline);

    }
    throw "Error";
}

void TTVirtualLink::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr TTVirtualLink::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getTTVirtualLink();
    return _eclass;
}
