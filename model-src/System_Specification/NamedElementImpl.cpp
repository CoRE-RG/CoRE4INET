...
/*
 * System_Specification/NamedElementImpl.cpp
...
::ecore::EClass_ptr NamedElement::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getNamedElement();
    return _eclass;
}
