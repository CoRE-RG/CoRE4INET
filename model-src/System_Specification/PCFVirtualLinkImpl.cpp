...
/*
 * System_Specification/PCFVirtualLinkImpl.cpp
...
/*PROTECTED REGION ID(PCFVirtualLinkImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void PCFVirtualLink::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(PCFVirtualLinkImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject PCFVirtualLink::eGet(::ecore::EInt _featureID,
...
void PCFVirtualLink::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean PCFVirtualLink::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__SIGNATURE:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_signature);
    case ::System_Specification::System_SpecificationPackage::VIRTUALLINK__DESTMACADDRESSCF:
        /*PROTECTED REGION ID(PCFVirtualLinkeIsSet__PCFVirtualLinkm_destMacAddressCF) ENABLED START*/
...
void PCFVirtualLink::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr PCFVirtualLink::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::System_Specification::System_SpecificationPackage_ptr > (::System_Specification::System_SpecificationPackage::_instance())->getPCFVirtualLink();
    return _eclass;
}
