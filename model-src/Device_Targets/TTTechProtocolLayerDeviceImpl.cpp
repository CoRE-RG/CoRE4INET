...
/*
 * Device_Targets/TTTechProtocolLayerDeviceImpl.cpp
...
#include "TTTechProtocolLayerDevice.hpp"
...
/*PROTECTED REGION ID(TTTechProtocolLayerDeviceImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void TTTechProtocolLayerDevice::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(TTTechProtocolLayerDeviceImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject TTTechProtocolLayerDevice::eGet(::ecore::EInt _featureID,
...
void TTTechProtocolLayerDevice::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean TTTechProtocolLayerDevice::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
...
void TTTechProtocolLayerDevice::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr TTTechProtocolLayerDevice::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Targets::Device_TargetsPackage_ptr > (::Device_Targets::Device_TargetsPackage::_instance())->getTTTechProtocolLayerDevice();
    return _eclass;
}
