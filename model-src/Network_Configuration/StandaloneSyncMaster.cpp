...
/*
 * Network_Configuration/StandaloneSyncMaster.cpp
...
// Default constructor
StandaloneSyncMaster::StandaloneSyncMaster()
{

    /*PROTECTED REGION ID(StandaloneSyncMasterImpl__StandaloneSyncMasterImpl) START*/
...
/*PROTECTED REGION ID(StandaloneSyncMaster.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
