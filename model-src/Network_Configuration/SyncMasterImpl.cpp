...
/*
 * Network_Configuration/SyncMasterImpl.cpp
...
/*PROTECTED REGION ID(SyncMasterImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void SyncMaster::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(SyncMasterImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject SyncMaster::eGet(::ecore::EInt _featureID,
...
void SyncMaster::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean SyncMaster::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_name);
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCBASE__SCHEDULEDRECEIVEPIT:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_scheduledReceivePit) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCBASE__ACCEPTANCEWINDOW:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_acceptanceWindow) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCBASE__LISTENTIMEOUT:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_listenTimeout) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCBASE__PRIORITYFALLBACKCYCLES:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_priorityFallbackCycles) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_priorityFallbackCycles != 0;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCBASE__SYNCTOSTABLEENABLED:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_syncToStableEnabled) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_syncToStableEnabled != false;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::ACTIVESYNCCOMPONENT__SOURCEMACADDRESS:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_sourceMacAddress) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    ...
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__MEMBERSHIPBIT:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_membershipBit) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_membershipBit != 0;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__INITIALINTEGRATIONCYCLE:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_initialIntegrationCycle) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__CAOFFSET:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_caOffset) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__COLDSTARTTIMEOUT:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_coldstartTimeout) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_coldstartTimeout != "0ns";
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__CSOFFSET:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_csOffset) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__RESTARTTIMEOUTASYNC:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_restartTimeoutAsync) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__RESTARTTIMEOUTSYNC:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_restartTimeoutSync) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Network_Configuration::Network_ConfigurationPackage::SYNCMASTER__CLKSYNCFILTERMAX:
        /*PROTECTED REGION ID(SyncMastereIsSet__SyncMasterm_clksyncFilterMax) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void SyncMaster::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr SyncMaster::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Network_Configuration::Network_ConfigurationPackage_ptr > (::Network_Configuration::Network_ConfigurationPackage::_instance())->getSyncMaster();
    return _eclass;
}
