...
/*
 * Device_Target_Mapping/MemoryBufferImpl.cpp
...
/*PROTECTED REGION ID(MemoryBufferImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void MemoryBuffer::_initialize()
{
    // Supertypes
    ::Device_Target_Mapping::Buffer::_initialize();

    // Rerefences

    /*PROTECTED REGION ID(MemoryBufferImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject MemoryBuffer::eGet(::ecore::EInt _featureID,
...
void MemoryBuffer::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean MemoryBuffer::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_name);
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__TYPE:
        /*PROTECTED REGION ID(MemoryBuffereIsSet__MemoryBufferm_type) ENABLED START*/
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__FLUSHONSCHEDULERESET:
        /*PROTECTED REGION ID(MemoryBuffereIsSet__MemoryBufferm_flushOnScheduleReset) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void MemoryBuffer::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr MemoryBuffer::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Target_Mapping::Device_Target_MappingPackage_ptr > (::Device_Target_Mapping::Device_Target_MappingPackage::_instance())->getMemoryBuffer();
    return _eclass;
}
