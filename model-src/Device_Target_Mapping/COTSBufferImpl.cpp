...
/*
 * Device_Target_Mapping/COTSBufferImpl.cpp
...
/*PROTECTED REGION ID(COTSBufferImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void COTSBuffer::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(COTSBufferImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject COTSBuffer::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::MEMORYBUFFER__BASEADDRESS:
    {
        ...
        return _any;
    case ::Device_Target_Mapping::Device_Target_MappingPackage::COTSBUFFER__REFTARGETPORT:
    {
...
void COTSBuffer::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::COTSBUFFER__REFTARGETPORT:
    {
        ...
        ::Device_Target_Mapping::COTSBuffer::setRefTargetPort(_t1);
    }
        return;
...
::ecore::EBoolean COTSBuffer::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_name);
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__TYPE:
        /*PROTECTED REGION ID(COTSBuffereIsSet__COTSBufferm_type) ENABLED START*/
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__FLUSHONSCHEDULERESET:
        /*PROTECTED REGION ID(COTSBuffereIsSet__COTSBufferm_flushOnScheduleReset) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void COTSBuffer::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr COTSBuffer::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Target_Mapping::Device_Target_MappingPackage_ptr > (::Device_Target_Mapping::Device_Target_MappingPackage::_instance())->getCOTSBuffer();
    return _eclass;
}
