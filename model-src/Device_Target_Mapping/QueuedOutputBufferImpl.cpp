...
/*
 * Device_Target_Mapping/QueuedOutputBufferImpl.cpp
...
/*PROTECTED REGION ID(QueuedOutputBufferImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void QueuedOutputBuffer::_initialize()
{
    // Supertypes
    ::Device_Target_Mapping::HostBuffer::_initialize();

    // Rerefences

    /*PROTECTED REGION ID(QueuedOutputBufferImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject QueuedOutputBuffer::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::MEMORYBUFFER__BASEADDRESS:
    {
        ...
        return _any;
    case ::Device_Target_Mapping::Device_Target_MappingPackage::QUEUEDOUTPUTBUFFER__REFOUTVIRTUALLINK:
    {
        _any = static_cast< ::ecore::EObject* > (m_refOutVirtualLink);
    }
        return _any;
...
void QueuedOutputBuffer::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::QUEUEDOUTPUTBUFFER__REFOUTVIRTUALLINK:
    {
        ...
        ::Device_Target_Mapping::QueuedOutputBuffer::setRefOutVirtualLink(_t1);
    }
        return;
...
::ecore::EBoolean QueuedOutputBuffer::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_name);
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__TYPE:
        /*PROTECTED REGION ID(QueuedOutputBuffereIsSet__QueuedOutputBufferm_type) ENABLED START*/
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__FLUSHONSCHEDULERESET:
        /*PROTECTED REGION ID(QueuedOutputBuffereIsSet__QueuedOutputBufferm_flushOnScheduleReset) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void QueuedOutputBuffer::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr QueuedOutputBuffer::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Target_Mapping::Device_Target_MappingPackage_ptr > (::Device_Target_Mapping::Device_Target_MappingPackage::_instance())->getQueuedOutputBuffer();
    return _eclass;
}
