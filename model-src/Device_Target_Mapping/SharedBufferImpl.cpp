...
/*
 * Device_Target_Mapping/SharedBufferImpl.cpp
...
/*PROTECTED REGION ID(SharedBufferImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void SharedBuffer::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(SharedBufferImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject SharedBuffer::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::MEMORYBUFFER__BASEADDRESS:
    {
        ...
        return _any;
    case ::Device_Target_Mapping::Device_Target_MappingPackage::SHAREDBUFFER__REFVIRTUALLINK:
    {
        _any = m_refVirtualLink->asEListOf< ::ecore::EObject > ();
    }
        return _any;
...
void SharedBuffer::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const& _newValue)
{
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::SHAREDBUFFER__REFVIRTUALLINK:
    {
        ::ecorecpp::mapping::EList_ptr _t0 =
                ::ecorecpp::mapping::any::any_cast<
                        ::ecorecpp::mapping::EList_ptr >(_newValue);
        ::Device_Target_Mapping::SharedBuffer::getRefVirtualLink().clear();
        ::Device_Target_Mapping::SharedBuffer::getRefVirtualLink().insert_all(
                *_t0);
    }
        return;
...
::ecore::EBoolean SharedBuffer::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_name);
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__TYPE:
        /*PROTECTED REGION ID(SharedBuffereIsSet__SharedBufferm_type) ENABLED START*/
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::BUFFER__FLUSHONSCHEDULERESET:
        /*PROTECTED REGION ID(SharedBuffereIsSet__SharedBufferm_flushOnScheduleReset) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
    ...
    case ::Device_Target_Mapping::Device_Target_MappingPackage::SHAREDBUFFER__REFVIRTUALLINK:
        return m_refVirtualLink && m_refVirtualLink->size();

    }
    throw "Error";
}

void SharedBuffer::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr SharedBuffer::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Target_Mapping::Device_Target_MappingPackage_ptr > (::Device_Target_Mapping::Device_Target_MappingPackage::_instance())->getSharedBuffer();
    return _eclass;
}
