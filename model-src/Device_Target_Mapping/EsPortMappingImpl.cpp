...
/*
 * Device_Target_Mapping/EsPortMappingImpl.cpp
...
/*PROTECTED REGION ID(EsPortMappingImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void EsPortMapping::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(EsPortMappingImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject EsPortMapping::eGet(::ecore::EInt _featureID,
...
void EsPortMapping::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean EsPortMapping::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::System_Specification::System_SpecificationPackage::NAMEDELEMENT__NAME:
        return ::ecorecpp::mapping::set_traits< ::ecore::EString >::is_set(
                m_name);
    case ::Device_Target_Mapping::Device_Target_MappingPackage::PORTMAPPING__RXLATENCYCORRECTION:
        /*PROTECTED REGION ID(EsPortMappingeIsSet__EsPortMappingm_rxLatencyCorrection) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Device_Target_Mapping::Device_Target_MappingPackage::PORTMAPPING__TXLATENCYCORRECTION:
        /*PROTECTED REGION ID(EsPortMappingeIsSet__EsPortMappingm_txLatencyCorrection) ENABLED START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return true;
        /*PROTECTED REGION END*/
    case ::Device_Target_Mapping::Device_Target_MappingPackage::PORTMAPPING__DISABLERXFC:
        /*PROTECTED REGION ID(EsPortMappingeIsSet__EsPortMappingm_disableRxFc) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
        return m_disableRxFc != false;
        /*PROTECTED REGION END*/
    case ::Device_Target_Mapping::Device_Target_MappingPackage::PORTMAPPING__DISABLETXFC:
        /*PROTECTED REGION ID(EsPortMappingeIsSet__EsPortMappingm_disableTxFc) START*/
        // Please, enable the protected region if you changed it.
        // To do this, add the keyword ENABLED before START.
...
void EsPortMapping::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr EsPortMapping::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Target_Mapping::Device_Target_MappingPackage_ptr > (::Device_Target_Mapping::Device_Target_MappingPackage::_instance())->getEsPortMapping();
    return _eclass;
}
