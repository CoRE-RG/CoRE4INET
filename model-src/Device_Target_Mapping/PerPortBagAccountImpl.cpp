...
/*
 * Device_Target_Mapping/PerPortBagAccountImpl.cpp
...
/*PROTECTED REGION ID(PerPortBagAccountImpl.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/

void PerPortBagAccount::_initialize()
{
    // Supertypes
    ...
    /*PROTECTED REGION ID(PerPortBagAccountImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject PerPortBagAccount::eGet(::ecore::EInt _featureID,
...
void PerPortBagAccount::eSet(::ecore::EInt _featureID,
...
::ecore::EBoolean PerPortBagAccount::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::System_Specification::System_SpecificationPackage::MODELELEMENT__EANNOTATIONS:
    ...
    case ::Device_Specification::Device_SpecificationPackage::BAGACCOUNT__CONSTRAINTYPE:
        /*PROTECTED REGION ID(PerPortBagAccounteIsSet__PerPortBagAccountm_constrainType) ENABLED START*/
...
void PerPortBagAccount::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
...
::ecore::EClass_ptr PerPortBagAccount::_eClass()
{
    static ::ecore::EClass_ptr
            _eclass =
                    dynamic_cast< ::Device_Target_Mapping::Device_Target_MappingPackage_ptr > (::Device_Target_Mapping::Device_Target_MappingPackage::_instance())->getPerPortBagAccount();
    return _eclass;
}
