...
/*
 * Device_Target_Mapping/InputBuffers.hpp
...
#ifndef DEVICE_TARGET_MAPPING_INPUTBUFFERS_HPP
#define DEVICE_TARGET_MAPPING_INPUTBUFFERS_HPP
...
/*PROTECTED REGION ID(InputBuffers_pre) START*/
...
namespace Device_Target_Mapping
{
    ...
    class InputBuffers: public virtual ::System_Specification::ModelElement
    {
    public:
        InputBuffers();
        ...
        /*PROTECTED REGION ID(InputBuffers) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
        ...
        /*PROTECTED REGION ID(InputBuffersImpl) START*/
        // Please, enable the protected region if you add manually written code.
        // To do this, add the keyword ENABLED before START.
        /*PROTECTED REGION END*/
...
#endif // DEVICE_TARGET_MAPPING_INPUTBUFFERS_HPP
